...
export default function Layout({ children, currentPageName }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-200 h-16 px-4 lg:px-6 flex items-center justify-between sticky top-0 z-50 shadow-sm">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="font-bold text-xl text-gray-900 tracking-tight">ALAB</span>
              <p className="text-[10px] text-gray-500 -mt-1 font-medium tracking-wide">SPORTS LEAGUE</p>
            </div>
            {isSuperAdmin && (
          ...
          <div className="h-full flex flex-col pt-6">
            <nav className="flex-1 px-4 space-y-2 overflow-y-auto">
              ...
              {isAdmin && !isSuperAdmin && (
                <Link
                  ...
                  onClick={() => setSidebarOpen(false)}
                  className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold text-gray-700 hover:bg-gray-100 mt-4 border-t border-gray-200 pt-6"
                >
            ...
            <div className="p-4 border-t border-gray-200 mt-auto bg-gray-50">
              ...
              <Button
                variant="outline"
                size="sm"
                className="w-full justify-start text-red-600 border-red-200 hover:bg-red-50 hover:text-red-700 hover:border-red-300 font-semibold"
                onClick={handleLogout}
              >
                <LogOut className="w-4 h-4 mr-2" />
                Logout
