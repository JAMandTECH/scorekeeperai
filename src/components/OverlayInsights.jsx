...
/**
 * Compact insights block for the stream overlay: fouls (+penalty) and
 * timeouts per team, top scorer, and foul-trouble count. Renders below
 * the team name. All three rows are always visible so the enhancement
 * is evident even before stats accumulate.
 */
export default function OverlayInsights({ fouls, timeouts, inPenalty, topScorer, foulTrouble, align }) {
