        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-black text-gray-900 dark:text-white">Scorekeeper Dashboard</h1>
                <p className="text-sm text-gray-600 dark:text-gray-400 font-medium">{organization?.name || 'Your Games'}</p>
              </div>
            </div>
